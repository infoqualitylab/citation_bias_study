...
plt.ylabel('Count')
plt.ylim([0,600])
plt.hist(neighbor_overlap, bins=bins, color='m', edgecolor='m', linewidth=1, histtype='bar', alpha=0.5, label='Real Network')
a.legend(loc='upper right')
b = plt.subplot(132)
plt.ylim([0,600])
plt.hist(neighbor_overlap_sim, bins=bins, color='b', edgecolor='b', linewidth=1, histtype='bar', alpha=0.5, label='Simulated Network')
