...
plt.ylabel('Count')
plt.ylim([0,600])
plt.hist(neighbor_overlap, bins=bins, color='darkorange', edgecolor='darkorange', linewidth=1, histtype='bar', alpha=0.5, label='Real Network', hatch="//")
a.legend(loc='upper right')
b = plt.subplot(132)
plt.ylim([0,600])
plt.hist(neighbor_overlap_sim, bins=bins, color='b', edgecolor='b', linewidth=1, histtype='bar', alpha=0.5, label='Simulated Network', hatch='.')
b.legend(loc='upper right')
#plt.legend(loc="upper right", label='Simulated Network')
#b.legend(['Simulated Network'])
#b.legend("234", loc="upper right")
plt.xlabel('Pairwise Neighbor Overlap Ratio')
plt.ylabel('Count')
plt.show()
'''
